...
```javascript
import UINT16_NUM_BYTES from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint16-num-bytes@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-uint16-num-bytes/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/constants-uint16-num-bytes/actions/workflows/test.yml?query=branch:v0.2.2
