...
```bash
npm install @stdlib/constants-uint16-num-bytes
```
...
[test-image]: https://github.com/stdlib-js/constants-uint16-num-bytes/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/constants-uint16-num-bytes/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/constants-uint16-num-bytes
